 ...
 this.setState({visibleShare:true});
  ...
  render(){
    ...
    <View style={{flex: 1, backgroundColor: '#fff'}}>
      ...
      <TouchableOpacity onPress={this.redirect.bind(this,'feedback')}>
        <View>
      ...
      <Hr lineColor='#BDBDBD'/>
        ...
        <View>
          <Text style={{margin: 10, marginTop:25, fontSize: 15, textAlign: 'left', fontWeight:'bold'}}> Chia sẻ </Text>
        </View>
      ...
      <TouchableOpacity onPress={()=>this.onOpen()}>
        <View>
          <Text style={{margin: 10, fontSize: 15, textAlign: 'left'}}> Chia sẻ ứng dụng </Text>
        </View>
      </TouchableOpacity>
      <ShareSheet visible={this.state.visibleShare} onCancel={this.onCancel.bind(this)}>
